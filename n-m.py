...
class Junction:
    ...
    def rho_l_function(self, road, b):
        ...
        if not result.converged:
            raise RuntimeError(
                f"rho_l root search failed on road {road.id}"
            )
...
def main():
    ...
    R2 = Road(2, rho_l=rho_l_R2,L=1.0, eta=1.1, lam=1.0, commodities=random_commodities(n_commodities))
    R3 = Road(3, rho_l=rho_l_R3,L=1.0, eta=1.1, lam=1.0, commodities=random_commodities(n_commodities))

    R4 = Road(4, rho_r=rho_r_R4,L=1.0, eta=1.1, lam=1.0, commodities=random_commodities(n_commodities))
    R5 = Road(5, rho_r=rho_r_R5,L=1.0, eta=1.1, lam=1.0, commodities=random_commodities(n_commodities))
    R6 = Road(6, rho_r=rho_r_R6,L=1.0, eta=1.1, lam=1.0, commodities=random_commodities(n_commodities))
    ...
    # commodity_destination_J1 = random_routing(n_commodities, [5,6,7])
    # commodity_destination_J1 ={0: 7, 1: 6, 2: 7, 3: 5, 4: 7}
    commodity_destination_J1 ={0: 4, 1: 5, 2: 6}
    print(commodity_destination_J1)
    ...
    J1 = Junction(
        junction_id=1,
        incoming_roads=[R1,R2, R3],
        outgoing_roads=[R4,R5,R6],
